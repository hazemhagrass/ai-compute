...
GLYPHS = {
    ...
    "interview-prep": '<circle cx="70" cy="122" r="6" fill="none" stroke="{g}" stroke-width="2.5"/><path d="M60 146 q10 -10 20 0" fill="none" stroke="{g}" stroke-width="2.5"/><circle cx="94" cy="122" r="6" fill="none" stroke="{g}" stroke-width="2.5"/><path d="M84 146 q10 -10 20 0" fill="none" stroke="{g}" stroke-width="2.5"/><path d="M72 128 l14 12 M92 128 l-14 12" stroke="{g}" stroke-width="2" stroke-linecap="round"/>',
    ...
    "citation-manager": '<path d="M70 116 q-8 8 0 16 q8 8 0 16" fill="none" stroke="{g}" stroke-width="3" stroke-linecap="round"/><path d="M80 116 q-8 8 0 16 q8 8 0 16" fill="none" stroke="{g}" stroke-width="3" stroke-linecap="round"/><path d="M92 132 h20 m-6 -6 l6 6 l-6 6" fill="none" stroke="{g}" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M92 148 h12" stroke="{g}" stroke-width="2.5" stroke-linecap="round"/>',

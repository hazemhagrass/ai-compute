...
GLYPHS = {
    "meeting-facilitation": '<path d="M62 128 h30 M62 138 h30 M62 148 h18" stroke="{g}" stroke-width="3" stroke-linecap="round"/><path d="M92 146 l4 4 8 -10" fill="none" stroke="{g}" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>',
    "copywriting-formulas": '<circle cx="80" cy="136" r="18" fill="none" stroke="{g}" stroke-width="3"/><circle cx="80" cy="136" r="10" fill="none" stroke="{g}" stroke-width="2.5"/><circle cx="80" cy="136" r="3" fill="{g}"/><path d="M64 118 l32 12" stroke="{g}" stroke-width="2.5" stroke-linecap="round"/><path d="M92 126 l4 4 -6 -1" fill="none" stroke="{g}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>',
    "subtitle-finder": '<rect x="60" y="124" width="32" height="5" rx="1" fill="none" stroke="{g}" stroke-width="2.5"/><rect x="60" y="134" width="26" height="5" rx="1" fill="none" stroke="{g}" stroke-width="2.5"/><rect x="60" y="144" width="30" height="5" rx="1" fill="none" stroke="{g}" stroke-width="2.5"/><circle cx="96" cy="148" r="7" fill="none" stroke="{g}" stroke-width="2.5"/><path d="M101 153 l6 6" stroke="{g}" stroke-width="3" stroke-linecap="round"/>',
    "site-test": '<rect x="58" y="118" width="44" height="30" rx="3" fill="none" stroke="{g}" stroke-width="2.5"/><circle cx="63" cy="123" r="1.4" fill="{g}"/><circle cx="67" cy="123" r="1.4" fill="{g}"/><circle cx="71" cy="123" r="1.4" fill="{g}"/><path d="M60 128 h40" stroke="{g}" stroke-width="1.5"/><path d="M65 134 h20 M65 140 h14" stroke="{g}" stroke-width="1.5" stroke-linecap="round"/><circle cx="92" cy="146" r="5" fill="none" stroke="{g}" stroke-width="2"/><path d="M96 150 l4 4" stroke="{g}" stroke-width="2" stroke-linecap="round"/>',
    "context-file-audit": '<rect x="60" y="120" width="26" height="32" rx="3" fill="none" stroke="{g}" stroke-width="3"/><path d="M66 129 h14 M66 136 h14 M66 143 h9" stroke="{g}" stroke-width="2.5" stroke-linecap="round"/><circle cx="92" cy="142" r="8" fill="none" stroke="{g}" stroke-width="3"/><path d="M97 147 l4 4" stroke="{g}" stroke-width="3" stroke-linecap="round"/>',
    "tableau-dashboard-builder": '<rect x="58" y="118" width="44" height="34" rx="3" fill="none" stroke="{g}" stroke-width="3"/><line x1="80" y1="118" x2="80" y2="152" stroke="{g}" stroke-width="2"/><rect x="63" y="136" width="4" height="11" fill="{g}"/><rect x="70" y="130" width="4" height="17" fill="{g}"/><polyline points="85,144 91,136 97,140" fill="none" stroke="{g}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>',
    "powerbi-reports": '<rect x="60" y="138" width="8" height="14" fill="{g}"/><rect x="72" y="130" width="8" height="22" fill="{g}"/><rect x="84" y="122" width="8" height="30" fill="{g}"/><polyline points="62,132 74,124 86,116" fill="none" stroke="{g}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="96" cy="120" r="3" fill="{g}"/>',
    "investment-portfolio-analyzer": '<circle cx="80" cy="135" r="17" fill="none" stroke="{g}" stroke-width="3"/><line x1="80" y1="135" x2="80" y2="118" stroke="{g}" stroke-width="2.5"/><line x1="80" y1="135" x2="95" y2="143" stroke="{g}" stroke-width="2.5"/><path d="M80 118 A17 17 0 0 1 95 143 L80 135 Z" fill="{g}" opacity="0.55"/>',
    "retirement-calculator": '<path d="M66 116 H94 L82 134 L94 152 H66 L78 134 Z" fill="none" stroke="{g}" stroke-width="3" stroke-linejoin="round"/><path d="M72 122 H88 L80 132 Z" fill="{g}" opacity="0.6"/><circle cx="80" cy="145" r="3.5" fill="{g}"/>',

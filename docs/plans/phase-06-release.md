...
- [ ] **[#27](https://github.com/hazemhagrass/ai-compute/issues/27) · Ship a Dockerfile and compose file** `M` — Deployment today is pnpm build && pnpm start on a machine with the right Node version. That is fine for localhost and nothing else.

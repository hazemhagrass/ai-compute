...
- [x] **[#9](https://github.com/hazemhagrass/ai-compute/issues/9) · Redact secrets from error messages returned to the browser** `S` — testConnection and chat return text.slice(0, 600) from a failed upstream response straight to the client. Several providers echo the submitted Authorization header or key fragment in their 4…

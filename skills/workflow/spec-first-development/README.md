...
- [`skill-authoring/`](../../meta/skill-authoring/SKILL.md) - writing new skills, itself a spec-first exercise.
- [`env-doctor/`](../../devtools/env-doctor/SKILL.md) - unblocking the environment when stage 4 or 5 fails for reasons unrelated to your code.

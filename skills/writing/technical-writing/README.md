...
- [spec-first-development](../../workflow/spec-first-development/SKILL.md) for writing the
  spec that a doc later describes.
- [truth-first](../../research/truth-first/SKILL.md) for not overstating what a tool does,

...
- [`planning`](../../workflow/planning/SKILL.md): use when turning a vague goal into
  dependency-ordered phases.
- [`spec-first-development`](../../workflow/spec-first-development/SKILL.md): use when
  building a feature from scratch, interview first and code last.
- [`grill-me`](../../workflow/grill-me/SKILL.md): use when stress-testing a plan or design,
